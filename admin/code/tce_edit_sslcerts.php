...
$ssl_user_id = isset($_REQUEST['ssl_user_id']) ? (int) $_REQUEST['ssl_user_id'] : (int) $_SESSION['session_user_id'];
            ...
            if (!F_check_unique(K_TABLE_TEST_SSLCERTS, 'tstssl_ssl_id=' . $ssl_id . '')) {
                ...
                echo
                    '<input type="hidden" name="ssl_name" id="ssl_name" value="'
                        . htmlspecialchars((string) $ssl_name, ENT_QUOTES, $l['a_meta_charset'])
                        . '" />'
                        . K_NEWLINE
                ;
        ...
        { // Add
            if (($formstatus = F_check_form_fields()) && strlen($ssl_hash) == 32) {
				...
				\''
                    ...
                    . '\',
				\''
                    . F_escape_sql($db, $ssl_hash)
                    . '\',
				\''
                    . F_escape_sql($db, $ssl_end_date)
                    . '\',
				\''
                    . (int) $ssl_enabled
                    . '\',
