 ...
 */
function custom_auth_test_check_login() {
    ...
    if (isset($_POST['logaction']) and ($_POST['logaction'] == 'login') and isset($_POST['xuser_name']) and isset($_POST['xuser_password'])) {
        ...
        if ($username == K_CUSTOM_AUTH_TEST_USERNAME && $password == K_CUSTOM_AUTH_TEST_PASSWORD){
            ...
            $usr['user_regnumber'] = '';
            $usr['user_ssn'] = '';
            $usr['user_level'] = K_CUSTOM_AUTH_TEST_USER_LEVEL;
            $usr['usrgrp_group_id'] = K_CUSTOM_AUTH_TEST_USER_GROUP_ID;
