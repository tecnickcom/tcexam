...
class TMXResourceBundle
{
    ...
    public function __construct(
        ...
        if (F_file_exists($this->cachefile)) {
            ...
            // sets the element handler functions for the XML parser (first-class callables keep the
            // private handler methods accessible without the deprecated xml_set_object(), PHP >= 8.4)
