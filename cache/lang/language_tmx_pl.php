...
$tmx['h_random_questions']='if selected, extracts randomly the questions related to each selected topic';
...
$tmx['hp_test_info']='Shows information for the selected test.';
