...
$tmx['d_tcexam_desc']='TCExam is a software for managing and perform online tests.';
$tmx['h_add']='adds current record to database';
$tmx['h_add_image']='inserts selected image into text';
$tmx['h_add_object']='inserts selected object into text';
$tmx['h_add_questions']='insert the selected type of questions';
$tmx['h_add_subject']='insert the selected subject on this test';
$tmx['h_add_tag']='inserts selected item';
...
$tmx['h_cancel']='cancels changes or the current operation';
$tmx['h_cancel_window']='closes form and cancels changes';
$tmx['h_clear']='resets form fields to blank';
$tmx['h_close_window']='closes window';
$tmx['h_continue']='continues test';
$tmx['h_database']='modifies database';
$tmx['h_delete']='deletes current record from database';
$tmx['h_display_all']='shows all answers including the ones already evaluated';
$tmx['h_display_user_info']='shows the data of the user who wrote this answer';
$tmx['h_email_all_results']='sends email test reports to all users';
$tmx['h_email_result']='sends email test report to users';
$tmx['h_enable_single_answer']='if selected, enables the single answer mode';
$tmx['h_enable_multiple_answers']='if selected, enables multiple answers mode';
$tmx['h_enable_free_answer']='if selected, enables free-text answer mode';
$tmx['h_enabled']='enables/disables current record';
$tmx['h_execute']='runs test';
...
$tmx['h_password_repeat']='repeat the password in this field to check possible digit mistakes';
$tmx['h_pdf']='generates a PDF document';
$tmx['h_pdf_all']='generates a detailed report for each user';
$tmx['h_pdf_offline_test']='generates PDF documents for off-line test execution';
$tmx['h_preview']='shows a preview of the code previously entered';
...
$tmx['h_results_to_users']='if selected, allows users to see results';
...
$tmx['h_update']='updates current data';
$tmx['h_upload_image']='specifies the path of an image to be sent to the server';
$tmx['h_upload_file']='specifies the path of the file to be sent to the server';
$tmx['h_user_info']='shows informations related to the user connected';
$tmx['h_usered_email']='user\'s email address (e.g.: name@domain.com)';
$tmx['h_view_details']='shows details';
...
$tmx['hp_login']='In order to access to the different sections of TCExam you must log in using the name and password provided to you by the system administrator';
...
$tmx['m_duplicate_regnumber']='this registration number has been already used, you must use another one';
$tmx['m_duplicate_ssn']='this SSN has been already used, you must use another one';
$tmx['m_duplicate_question']='this question has been already entered';
...
$tmx['m_upload_yes']='file correctly sent';
...
$tmx['t_test_results']='Tests Results';
...
$tmx['t_user_select']='Users Selection';
...
$tmx['m_unavailable_questions']='the selected questions are not available on database';
$tmx['w_status']='status';
$tmx['w_lock']='lock';
$tmx['w_unlock']='unlock';
$tmx['w_locked']='locked';
$tmx['w_unlocked']='unlocked';
$tmx['h_add_five_minutes']='adds five minutes';
...
$tmx['h_enable_ordering_answer']='if selected, enables the ordering answers mode';
