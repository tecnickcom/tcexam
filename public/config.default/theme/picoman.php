 ...
 * email: mamansulaeman86@gmail.com | telegram: @mamans86 | blog: https://mamans86.blogspot.com
 * TCExam Mobile First Design Theme based on Pico.css (https://picocss.com)
...
document.querySelector("body").insertAdjacentHTML("beforeend", "<div style='padding:0 1rem 1rem 1rem;text-align:center;background:var(--contrast);color:var(--background)'><span style='font-size:0.85rem'><a style='color:var(--color-warning)' href='#'>PicoMan Theme</a> created with love by <a style='color:var(--color-warning)' href='#'>mamans86</a></span></div>");
document.getElementById("scrollayer").insertAdjacentHTML("beforeend", "<div style='position:fixed;bottom:1rem;right:1rem'><span style='font-size:0.75rem'><a href='#'>TCExam PicoMan Theme</a></span></div>");
